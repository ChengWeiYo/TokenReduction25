...
python plot.py --keep_serials 30 --keep_methods bl cla clca --type_plot box --x_var_name kr --y_var_name acc --hue_var_name method --output_file box_acc_vs_kr_method_30_detail_title --fig_size 6 4 --title "Acc. Distribution (9 Backbones, 10 Datasets) for KRs w/ and w/o CLCA" --x_label "Keep Rate (KR, %)"

python plot.py --keep_serials 30 --keep_methods bl clca --type_plot box --x_var_name pt --y_var_name acc --hue_var_name method --output_file box_acc_vs_pt_method_30_title --fig_size 9 4 --x_rotation 30 --title "Acc. Distribution (5 Keep Rates, 10 Datasets) for SotA PT Backbones w/ and w/o CLCA" --x_label "Pretrained (PT) Backbone"
python plot.py --keep_serials 30 --keep_methods bl cla clca --type_plot box --x_var_name pt --y_var_name acc --hue_var_name method --output_file box_acc_vs_pt_method_30_detail_title --fig_size 9 4 --x_rotation 30 --title "Acc. Distribution (5 Keep Rates, 10 Datasets) for SotA PT Backbones w/ and w/o CLCA" --x_label "Pretrained (PT) Backbone"

python plot.py --keep_serials 30 --keep_methods bl clca --type_plot box --x_var_name dataset_name --y_var_name acc --hue_var_name method --output_file box_acc_vs_ds_method_30_title --fig_size 9 4 --x_rotation 30 --title "Acc. Distribution (9 Backbones, 5 KRs) for Datasets w/ and w/o CLCA" --x_label "Dataset Name (DS)"
python plot.py --keep_serials 30 --keep_methods bl cla clca --type_plot box --x_var_name dataset_name --y_var_name acc --hue_var_name method --output_file box_acc_vs_ds_method_30_detail_title --fig_size 9 4 --x_rotation 30 --title "Acc. Distribution (9 Backbones, 5 KRs) for Datasets w/ and w/o CLCA" --x_label "Dataset Name (DS)"

python plot.py --keep_serials 30 --keep_methods bl cla clca --type_plot violin --x_var_name pt --y_var_name acc --hue_var_name method --output_file violin_acc_vs_pt_method_30_detail_title --fig_size 9 4 --x_rotation 30 --title "Acc. Distribution (5 Keep Rates, 10 Datasets) for SotA PT Backbones w/ and w/o CLCA" --x_label "Pretrained (PT) Backbone"
python plot.py --keep_serials 30 --keep_methods bl cla clca --type_plot violin --x_var_name kr --y_var_name acc --hue_var_name method --output_file violin_acc_vs_kr_method_30_detail_title --fig_size 6 4 --title "Acc. Distribution (9 Backbones, 10 Datasets) for KRs w/ and w/o CLCA" --x_label "Keep Rate (KR, %)"
python plot.py --keep_serials 30 --keep_methods bl cla clca --type_plot violin --x_var_name dataset_name --y_var_name acc --hue_var_name method --output_file violin_acc_vs_ds_method_30_detail_title --fig_size 9 4 --x_rotation 30 --title "Acc. Distribution (9 Backbones, 5 Keep Rates) for Datasets w/ and w/o CLCA" --x_label "Dataset Name (DS)"

python plot.py --keep_serials 30 --keep_methods bl cla clca --type_plot box --x_var_name pt --y_var_name acc_std --hue_var_name method --output_file box_acc_stdev_vs_pt_method_30_detail_title --fig_size 9 4 --x_rotation 30 --title "Acc. Std. Dev. Distribution (5 Keep Rates, 10 Datasets) for SotA PT Backbones w/ and w/o CLCA" --x_label "Pretrained (PT) Backbone" --y_label "Acc. Std. Dev. (%)"
python plot.py --keep_serials 30 --keep_methods bl cla clca --type_plot box --x_var_name kr --y_var_name acc_std --hue_var_name method --output_file box_acc_stdev_vs_kr_method_30_detail_title --fig_size 6 4 --title "Acc. Std. Dev. Distribution (9 Backbones, 10 Datasets) for KRs w/ and w/o CLCA" --x_label "Keep Rate (KR, %)" --y_label "Acc. Std. Dev. (%)"
python plot.py --keep_serials 30 --keep_methods bl cla clca --type_plot box --x_var_name dataset_name --y_var_name acc_std --hue_var_name method --output_file box_acc_stdev_vs_ds_method_30_detail_title --fig_size 9 4 --x_rotation 30 --title "Acc. Std. Dev. Distribution (9 Backbones, 5 Keep Rates) for Datasets w/ and w/o CLCA" --x_label "Dataset Name (DS)" --y_label "Acc. Std. Dev. (%)"
