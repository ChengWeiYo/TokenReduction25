...
DATASETS = ('SoyLocal')
MODEL_NAMES_ALL = (
    'vit_base_patch16_clip_224.laion2b_fz_101',
    'vit_base_patch16_clip_224.laion2b_fz_101',
    'vit_base_patch16_clip_224.laion2b_ft_101',
    'vit_base_patch16_clip_224.laion2b_cla_ft_101',
    'vit_base_patch16_clip_224.laion2b_cla_clc_1_ft_101',
    'evit_vit_base_patch16_clip_224.laion2b_0.25_ft_101',
    'evit_vit_base_patch16_clip_224.laion2b_0.25_cla_ft_101',
    'evit_vit_base_patch16_clip_224.laion2b_0.25_cla_clc_1_ft_101',
)
VIS_TYPE_ALL = ('None', 'rollout_0_4', 'rollout_0_4', 'rollout_0_4', 'rollout_0_4', 'rollout_0_4', 'rollout_0_4', 'rollout_0_4')
VIS_LABELS_ALL = ('Samples', 'FZ ViT', 'FT ViT', 'ViT+CLA', 'ViT+CLCA', 'EViT', 'EViT+CLA', 'EViT+CLCA')
...
# VIS_TYPE = ('None', 'rollout_0_4', 'rollout_0_4', 'rollout_0_4', 'rollout_0_4')
VIS_TYPE = ('None', 'rollout_0_4', 'rollout_0_4')
# VIS_LABELS = ('Samples', 'ViT', 'ViT+CLCA', 'EViT', 'EViT+CLCA')
VIS_LABELS = ('Samples', 'EViT', 'CLCA')
...
def make_img_grid(args):
    ...
    for file in files:
        # full_names = [f'{file}.png'.replace('None', vis) for file in files]
...
def main():
    ...
    parser.add_argument('--file_folder', type=str,
                        default=os.path.join('data', 'results_inference', 'dfsm', 'clip'),
                        help='name of folder which contains the results')
    parser.add_argument('--subfolder', type=str, default='soylocal')
    parser.add_argument('--number_images_per_ds', type=int, default=8)
    parser.add_argument('--test_images', action='store_true')
    parser.add_argument('--image_size', default=224, type=int, help='file size')
    parser.add_argument('--save_name', default='dfsm_clip_soylocal', type=str, help='File path')
